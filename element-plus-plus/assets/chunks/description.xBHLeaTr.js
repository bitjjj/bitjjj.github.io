import{E as v}from"./index.DbdmvmR9.js";import{y as f,r as u,ag as r,z as p,A as b,Q as o,I as l,P as _,M as w,H as h,L as C,B as m,u as V}from"./framework.CPxOa8kE.js";import{g as x}from"./theme.CPYnN67Q.js";const H=f({__name:"basic",setup(g){const e=u(!1),s=()=>{e.value=!e.value};return(c,n)=>{const t=v,a=r("el-button");return p(),b(_,null,[o(t,{modelValue:e.value,"onUpdate:modelValue":n[0]||(n[0]=i=>e.value=i),title:"This is Banner",effect:"dark"},null,8,["modelValue"]),o(a,{onClick:s},{default:l(()=>n[1]||(n[1]=[w("Show/Hide")])),_:1})],64)}}}),z=`<template>
